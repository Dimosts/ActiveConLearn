This repository contains the code for the active constraint acquisition systems described in our AAAI 2024 paper "Learning to Learn in Interactive Constraint Acquisition".
